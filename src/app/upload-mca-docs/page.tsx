    ...
    <div className="flex justify-center items-center min-h-screen">
      <div className="[background:linear-gradient(269.75deg,_#011049,_#19112f_25.75%,_#251431_51.79%,_#301941_64.24%,_#6e3050)] shadow-md rounded-lg p-6 w-full max-w-lg">
        ...
        <p className="mb-6 text-center text-sm text-zinc-400">
          Please upload the required documents for this company. For your convenience, the CIN &
          UserID have already been pre-filled from the URL.
        </p>
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div className="form-group">
            <label htmlFor="cin" className="block text-sm font-medium text-zinc-400 mb-1">
              CIN
            </label>
            <Input
              type="text"
          ...
          <div className="form-group">
            <label htmlFor="userId" className="block text-sm font-medium text-zinc-400 mb-1">
              User ID
            </label>
            <Input
              type="text"
