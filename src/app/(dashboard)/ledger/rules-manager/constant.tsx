...
export const columns = (accounts: string[], handleFetchRules: () => void) => [
  ...
  },
  {
    ...
    cell: (info: { getValue: () => void }) => (
      <h1 className="font-normal tracking-wider cursor-pointer">
        {info.getValue()!}
      </h1>
    ),
  },
  {
    ...
    cell: (info: { getValue: () => void }) => {
      ...
      return (
        <h1 className="font-normal tracking-wider cursor-pointer">{account}</h1>
      );
    },
  },
  {
