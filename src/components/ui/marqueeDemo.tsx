      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-8">
        <div className="w-full text-center md:text-left">
          ...
          <h2 className="text-4xl font-semibold text-center mb-8">
            Experience <span className="text-gradient">Matters</span>
          </h2>
          <p className="text-sm text-center text-gray-400 mb-16 leading-relaxed mx-auto max-w-3xl">
          Our board of advisors brings unparalleled expertise—leaders who've built billion-dollar ventures, reshaped policies, and driven innovation across industries. Explore some of their most remarkable achievements!
          </p>
        </div>
      </div>
