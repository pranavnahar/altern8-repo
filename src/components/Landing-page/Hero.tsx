      ...
      <div className="max-w-[1320px] h-[300px] mx-auto px-5 sm:px-0 xl:px-0">
        <div className="max-w-[1320px] mx-auto flex flex-col md:flex-row">
          ...
          <div className="hidden md:inline text-left basis-1/2 text-white">
            ...
            >
              Discover a new era in lending with Altern8, your ultimate alternate platform and marketplace connecting Real Estate borrowers with patrons. As a trailblazer in the industry, Altern8 serves as the end-to-end originator and distributor of real estate assets and loans, leveraging cutting-edge data science, Artificial Intelligence, and Machine Learning techniques. We specialize in demystifying complex industries with opaque data, starting with our fully automated data aggregation stack that delivers results in minutes, beginning with just a simple mobile number.
            </motion.div>
          </div>
        </div>
      </div>
