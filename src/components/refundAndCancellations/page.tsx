    ...
    <div className="relative overflow-x-hidden [background:linear-gradient(269.75deg,_#011049,_#19112f_25.75%,_#251431_51.79%,_#301941_64.24%,_#6e3050)] w-full min-h-screen">
      ...
      <div className="my-10">
        ...
        <p className={contentClassName}>
          ...
          whatsoever, such user shall immediately intimate Altern8 Club of the same. Such refund (if
          any) shall be effected by Altern8 Club via payment gateway or such other means as Altern8
        ...
        <div className="my-10">
          ...
          <p className={contentClassName}>
            2.1 The User shall contact Altern8 Club for any fraudulent transaction(s) on account of
            misuse of card/ Bank details by a fraudulent individual/party and such issues shall be
            suitably addressed by Altern8 Club in line with their policies and rules.
          </p>
          <p className={contentClassName}>
            ...
            request. Provided that no refund request in respect of a transaction settled by Altern8
        ...
        <div className="my-10">
          ...
          <ol className="list-[lower-alpha] ml-6 list-inside space-y-4">
            <li className={`${contentClassName} ml-6`}>
              ...
              the payment twice and immediately thereafter contact Altern8 Club via e-mail or any
              other mode of contact as provided by Altern8 Club to confirm payment.
            </li>
            <li className={`${contentClassName} ml-6`}>
        ...
        <div className="my-10">
          ...
          <p className={contentClassName}>
            4.2 Altern8 Club will revert back to the User regarding Cancellation requests made within
          ...
          <ol className="list-[lower-alpha] ml-6 list-inside space-y-4">
            ...
            <li className={`${contentClassName} ml-6`}>
              In case Altern8 Club fails to open an account within 10 days of submission of all the
            ...
            <li className={`${contentClassName} ml-6`}>
              ...
              being so intimated, Altern8 Club shall initiate the necessary procedure to refund these
            ...
            <li className={`${contentClassName} ml-6`}>
              ...
              with a clear reason can be sent by the Patron to Altern8 Club. As the account opening
              ...
              will be considered by Altern8 Club on a case to case basis.
              <br />
              <br />
              Patrons understand that completion of all refund procedures initiated by Altern8 Club is
